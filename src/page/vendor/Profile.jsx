        ...
        <div className="bg-gray-100 min-h-screen py-6 space-y-5">
            <div className="flex justify-end w-[96%] ">
                <button
                    ...
                    className="px-3 py-2 w-48 rounded-md shadow shadow-[#dcdedf] cursor-pointer hover:bg-[#4283ac] bg-[#286a94] text-white"
                >
                    Change Password
                </button>            </div>
            {/* ================= PERSONAL DETAILS ================= */}
...
function ChangePasswordModal({ onClose }) {
  ...
  const onSubmit = async (data) => {
    ...
    try{
        const result = await submit({current_password: currentPassword,
        ...
        <div className={`modal-wrap ${animCls}`} style={{ position:"relative", zIndex:2, width:430, maxWidth:"95vw" }}>
          <div className="modal" style={{
            ...
            <div style={{
              ...
              background:"linear-gradient(90deg,#286a94,#4fb3e8,#286a94,#4fb3e8)",
            ...
            <div style={{
              ...
              background:"radial-gradient(circle,rgba(40,106,148,0.12) 0%,transparent 70%)",
